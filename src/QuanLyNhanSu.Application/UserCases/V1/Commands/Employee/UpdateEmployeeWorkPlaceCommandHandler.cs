...
public sealed class UpdateEmployeeWorkPlaceCommandHandler : ICommandHandler<Command.UpdateEmployeeWorkPlaceCommand>
{
    ...
    public UpdateEmployeeWorkPlaceCommandHandler
    (
        IUnitOfWork unitOfWork, IRepositoryBase<Domain.Entities.Employee, 
        Guid> employeeRepository, IRepositoryBase<Domain.Entities.Department, Guid> departmentRepository, 
    ...
    public async Task<Result> Handle(Command.UpdateEmployeeWorkPlaceCommand request, CancellationToken cancellationToken)
    {
        ...
        employee.UpdateEmployeeWorkPlace(request.WorkPlaceId);
