...
namespace QuanLyNhanSu.Persistence.Migrations
{
    ...
    [Migration("20241201065552_AddPayRoll")]
            ...
            modelBuilder.Entity("QuanLyNhanSu.Domain.Entities.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c08a1e77-0748-47bd-a98d-50561c0b8c30",
                        ...
                        new
                        {
                            Id = "a7fc8ca5-d41d-4287-9422-cab99da87621",
                        ...
                        new
                        {
                            Id = "e89543fc-5917-4eea-8663-eec665bec22e",
                        ...
                        new
                        {
                            Id = "ae0e79c0-7ca9-4c67-8759-3180e885499a",
            ...
            modelBuilder.Entity("QuanLyNhanSu.Domain.Entities.PayRoll", b =>
                {
                    ...
                    b.HasOne("QuanLyNhanSu.Domain.Entities.Employee", null)
                        .WithMany("PayRolls")
